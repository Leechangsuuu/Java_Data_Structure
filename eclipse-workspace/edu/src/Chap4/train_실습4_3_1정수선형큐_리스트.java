...
//		return que + ',' + capacity + "," + front + "," + rear + "," + num; 
//	}
...
//--- 큐에서 데이터를 디큐 ---//
	public int deque() throws EmptyQueueException {
		...
		int data = que.get(front); //큐에서 가져온 front값을 data에 저장
		que.remove(front);//가져온 front값 제거
		rear--;
		num--;
		System.out.println("디큐완료 : " + data);
		return data;
	}
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1: // 인큐
				...
				try {
					oq.enque(rndx);
				} catch(Chap4.Queue4.OverflowQueueException e) {
			...
			case 2: // 디큐
				...
				} catch (Chap4.Queue4.EmptyQueueException e) {
