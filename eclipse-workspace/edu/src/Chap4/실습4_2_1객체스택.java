...
public class 실습4_2_1객체스택 {
	...
	public static void main(String[] args) {
		...
		실습4_2_1객체스택 s = new 실습4_2_1객체스택(8); // 최대 8 개를 push할 수 있는 stack
		...
		while (true) {
			...
			case 1: // 푸시
				...
				try {
					s.push(p);
				} catch(실습4_2_1객체스택.OverflowGenericStackException e) {
			...
			case 2: // 팝
				...
				} catch(실습4_2_1객체스택.EmptyGenericStackException e) {
